...
class DeploymentOrderView(
    ...
    var selectedConfig: CMTConfiguration? = null
    ...
    init {
        ...
        val saveButton = Button("Save", Icon("lumo", "download")) { event -> this.handleSaveButtonClick(event)}
    ...
    private fun handleSaveButtonClick(event: ClickEvent<Button>?) {
        ...
        //TODO: send DeploymentOrder to deploymentOrderService to save and trigger deployment

        //deploymentOrder.config = selectedConfig
        //TODO: show any issues to user...
